...
ggplot(PolarBearLate.Carbon.Components) +
  ...
  ylab("Stable Isotope Ratios (ppt)")
```
9. The graph above depicts the trend data for stable carbon isoptope concentrations from polar bear samples collected in the Beafuort and Chukchi Seas from 2004-2017.
```{r warning=FALSE, echo=FALSE}
ggplot(PolarBearLate.Nitrogen.Components) +
  ...
  ylab("Stable Isotope Ratios (ppt)")
```
10. The graph above depicts the trend data for stable nitrogen isoptope concentrations from polar bear samples collected in the Beafuort and Chukchi Seas from 2004-2017.
